...
public class ElevensBoard extends Board {
	 ...
	 */
	@Override
	public ArrayList<Integer> isLegal(List<Integer> selectedCards) {
	...
	public boolean anotherPlayIsPossible() {
		...
		return containsPairSum11(cIndexes) != null || containsJQK(cIndexes) != null;
	}
	 ...
	 */
	private ArrayList<Integer> containsPairSum11(List<Integer> selectedCards) {
	 ...
	 */
	private ArrayList<Integer> containsJQK(List<Integer> selectedCards) {
	...
	public boolean playIfPossible() {
		if (anotherPlayIsPossible()){
			super.replaceSelectedCards(isLegal(super.cardIndexes()));
			return true;
		}
		return false;
	}
