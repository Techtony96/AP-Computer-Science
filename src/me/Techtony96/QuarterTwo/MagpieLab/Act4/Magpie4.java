package me.Techtony96.QuarterTwo.MagpieLab.Act4;
...
public class Magpie4 {
	...
	public String getResponse(String statement) {
		...
		// Responses which require transformations
			...
			response = "Would you really be happy if you had " + statement.toLowerCase().replace("i want", "").trim() + "?";
		}  else if (findKeyword(statement, "I like", 0) >= 0) {
			response = "Why do you " + statement.toLowerCase().replace("you", "").replace("i ", "").replace(".", "").trim() + " me?";
		}
